...
int main(int argc, char** argv){
	...
	for (uint32_t i = 0; i < Nthr.size(); i++){
		...
		oss  << "sdadpmix-sun-nThr_" << std::setfill('0') << std::setw(3) << Nthr[i];
	...
	oss5 << "vardpmixold-sun-trace.log";
